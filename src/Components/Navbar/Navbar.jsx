...
const {user,logOut}=useContext(AuthContext)
  ...
  <li><NavLink to="/about" className={({ isActive, isPending }) => isPending ? "pending" : 
  isActive ? "text-green-400 underline" : "" }>About</NavLink> </li>
...
<li><NavLink to="/gallery" className={({ isActive, isPending }) => isPending ? "pending" : 
  ...
  <div className="navbar-start">
    ...
    <a className="btn btn-ghost normal-case text-xl">Social Event</a>
  </div>
